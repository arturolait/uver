...
-->
    ...
    <body style="font-family: fantasy;">
        ...
        <main class="container-main">
            <div class="p-5">
                <div>
                    <h3>SISTEMA INTEGRAL DE INFORMACIÓN - <small class="text-muted">CURRICULUM UV</small></h3>
                </div> 
                <br>          
                <div class="bg-light p-5 rounded" style="border: 1px solid">
                    ...
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <!--<button class="nav-link disabledBtn" id="nav-actDisiplinar-tab" data-bs-toggle="tab" data-bs-target="#nav-actDisiplinar" type="button" role="tab" onclick="setHtmlContent('actualizacion_disiplinar')" disabled>Actualización disiplinar</button>-->
