...
class Persona{
    ...
    public function registraPersona(){
        ...
        try{
            ...
            $SQL = "INSERT INTO ".DB_NAME.".".$this->_tablaName." (apPaterno, apMaterno, nombre, fechaNacimiento, noProfesor, nombramiento, antiguedad)
                VALUES(:apPaterno, :apMaterno, :nombre, :fechaNacimiento, :noProfesor, :nombramiento, :antiguedad);";
    ...
    public function actualizaPersona(){
        ...
        try{
            ...
            $SQL = "UPDATE ".DB_NAME.".".$this->_tablaName."
                SET apPaterno=:apPaterno, apMaterno=:apMaterno, nombre=:nombre, fechaNacimiento=:fechaNacimiento, noProfesor=:noProfesor, nombramiento=:nombramiento, antiguedad=:antiguedad, fechaContratacion=:fechaContratacion 
                ".$where;
            $result = $this->conexion->dbc->prepare($SQL);
            $result->bindParam(':apPaterno', $this->apPaterno);
            $result->bindParam(':apMaterno', $this->apMaterno);
    ...
    public function consultaByNoProfesor(){
        ...
        $SQL = "SELECT persona_key, apPaterno, apMaterno, nombre, DATE_FORMAT(fechaNacimiento, '%d/%m/%Y') as fechaNacimiento, noProfesor, 
                    nombramiento, antiguedad, DATE_FORMAT(fechaContratacion, '%d/%m/%Y') as fechaContratacion
