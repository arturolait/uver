...
if(isset($_POST["formacion_key"]) && isset($_POST["persona_fkey"])){
    ...
    $formacion->setCondicion("gestion_key", $gestion->getGestionKey(), IGUAL, NUMERO);

    $gestion->eliminaGestion();

    $gestion->clearCondicion();
    $formagestionon->setCondicion("persona_fkey", $gestion->getProfesionalKey(), IGUAL, NUMERO);
    $agestion = $formacion->consultaByIdProfesor();
